...
pickupEntry = None      # Entry widget for pickup time (HH:MM)
...
def create_data_entry_page(tab_control):
    ...
    pickupLabel = tk.Label(data_entry_frame, text="Enter the Pick Up time (HH:MM)", font=("Cambria", 14), bg='darkgoldenrod', fg='black')
    ...
    pickupEntry = tk.Entry(data_entry_frame, foreground="black", background="khaki", font=("Cambria", 14), width=10)
    ...
    amPmLabel.grid(row=7, column=0, padx=10, pady=5)

    am_pm_values = ("AM", "PM")
    global amPmCombobox
    amPmCombobox = ttk.Combobox(data_entry_frame, values=am_pm_values, font=("Cambria", 14), width=10)
    amPmCombobox.grid(row=7, column=1, padx=10, pady=5)
...
def main():
    ...
    package_box_label = tk.Label(master, image=package_box_photo, bg='darkslategray')
    package_box_label.photo = package_box_photo
    package_box_label.grid(row=2, column=0, padx=10, pady=10)

    delivery_truck_label = tk.Label(master, image=delivery_truck_photo, bg='darkslategray')
    delivery_truck_label.photo = delivery_truck_photo
    delivery_truck_label.grid(row=3, column=0, padx=10, pady=10)